...
todoApp.controller('TodoController', function ($scope, $q, $timeout, $ionicActionSheet, $ionicModal, Positions, HisData, $ionicSideMenuDelegate, $http) {
...
todoApp.factory('HisData', ['$http', '$q', function ($http, $q) {
  return {
